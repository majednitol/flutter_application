...
class ProductsList {
  ...
  String? _message;
  List<Data>? _data;
ProductsList copyWith({  bool? success,
  String? message,
  List<Data>? data,
}) => ProductsList(  success: success ?? _success,
